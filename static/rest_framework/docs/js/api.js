...
$(function () {
  ...
  // Authentication: none
  $authControl.find("[data-authe='none']").click(function (event) {
    event.preventDefault()
    window.auth = null
    $selectedAuthentication.text('none')
    $authControl.find("[data-authe]").closest('li').removeClass('active')
    $authControl.find("[data-authe='none']").closest('li').addClass('active')
  })
  ...
  $('form.authentication-token-form').submit(function (event) {
    ...
    $authControl.find("[data-authe]").closest('li').removeClass('active')
    $authControl.find("[data-authe='token']").closest('li').addClass('active')
  ...
  $('form.authentication-basic-form').submit(function (event) {
    ...
    $authControl.find("[data-authe]").closest('li').removeClass('active')
    $authControl.find("[data-authe='basic']").closest('li').addClass('active')
  ...
  $('form.authentication-session-form').submit(function (event) {
    ...
    $authControl.find("[data-authe]").closest('li').removeClass('active')
    $authControl.find("[data-authe='session']").closest('li').addClass('active')
